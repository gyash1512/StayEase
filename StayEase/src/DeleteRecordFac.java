...
public class DeleteRecordFac extends JFrame implements ActionListener {
    JLabel l1,l2,l3;
    JTextField t1,t2;
    JButton b1,b2;
...
// Add an ActionListener to handle button clicks
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
            ...
            try{
                String str = "delete from ticketfac where FacultyID = '"+enrollment+"' AND RoomNo = '"+room+"'";
    ...
    public static void main(String[] args){
        new DeleteRecordFac().setVisible(true);;
    }
}
