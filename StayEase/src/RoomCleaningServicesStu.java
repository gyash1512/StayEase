...
public class RoomCleaningServicesStu extends JFrame implements ActionListener {
    ...
    RoomCleaningServicesStu(){
        ...
        JLabel l9 = new JLabel("Enrollment No.");
        l9.setFont(new Font("Raleway",Font.BOLD,20));
        l9.setBounds(60,550,150,30);
...
// Add an ActionListener to handle button clicks
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            conn c = new conn();
            try{
                String str = "insert into ticketstu values('"+enroll+"','"+dateFrom+"','"+dateTo+"','"+timeFrom+"','"+timeTo+"','"+room+"','"+services+"')";
